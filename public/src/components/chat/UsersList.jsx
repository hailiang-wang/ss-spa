...
var UsersList = React.createClass({
  ...
  refreshSuperScriptResponseData: function (data) {
    console.log('refreshSuperScriptResponseData', data)
  ...
  componentDidMount: function () {
    ...
    self.props.chatProxy.onSuperScriptResponseUpdate(this.refreshSuperScriptResponseData.bind(this));
  },
  ...
  render: function () {
    ...
    return (
      <div className="users-list col-xs-6">
        <div ref="aceEidtor" style={style}></div>
      </div>
    );
  }
});
